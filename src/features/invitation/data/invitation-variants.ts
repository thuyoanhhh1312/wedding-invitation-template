...
const heroDate = createInvitationEventDate('2025-12-29');
const eventDate = createInvitationEventDate('2025-11-29', 'Tức ngày 10 tháng 10 âm lịch');
const partyDate = createInvitationEventDate('2026-10-28', 'Tức ngày 19 tháng 9 âm lịch');
export const invitationContent: InvitationContent = {
  ...
  party: {
    ...
    date: partyDate.displayShort,
    dayLabel: partyDate.weekdayLabel,
    image: doorwayCouple,
    note: partyDate.lunarNote ?? '',
  ...
  schedule: {
    ...
    photo: flowerBride,
    subline: `${partyDate.lunarNote ?? ''} | 10:00 AM`,
    summary: [
