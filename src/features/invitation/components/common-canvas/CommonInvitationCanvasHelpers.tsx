...
export function buildCommonCanvasModel(
  ...
  return {
    ...
    familyLead,
    familySupport,
    partyVenue: variant.id === 'common' ? content.party.venue : variant.ceremonyVenue,
    isCommonGiftLayout: variant.id === 'common',
    scheduleSummaryText: content.schedule.summary.join(' '),
    welcomeTitleWords: content.welcome.title.split(' '),
  };
}
