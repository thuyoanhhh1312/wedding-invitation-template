...
export function InviteSection({ content, model }: InviteSectionProps) {
  return (
    <section className='bg-[#5d1b18] px-8 pb-12 pt-70 text-center text-[#efe2d1]'>
      ...
      <p className='font-display mt-7 text-[1.85rem] leading-none tracking-[0.08em]'>{model.partyVenue}</p>
